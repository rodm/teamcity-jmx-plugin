...
:uri-github-build: https://github.com/rodm/teamcity-jmx-plugin/actions
:uri-github-status: https://github.com/rodm/teamcity-jmx-plugin/workflows/Build/badge.svg
:plugin-id: 10872-jmx-support
:uri-jetbrains-plugin: https://plugins.jetbrains.com/plugin/{plugin-id}
:uri-jetbrains-plugin-version: https://img.shields.io/jetbrains/plugin/v/{plugin-id}
:uri-jetbrains-plugin-downloads: https://img.shields.io/jetbrains/plugin/d/{plugin-id}
...
image:{uri-jetbrains-plugin-version}["Version", link="{uri-jetbrains-plugin}"]
image:{uri-jetbrains-plugin-downloads}["Downloads", link="{uri-jetbrains-plugin}"]
